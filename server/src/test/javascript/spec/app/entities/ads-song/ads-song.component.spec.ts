...
import { AdsSongComponent } from 'app/entities/ads-song/ads-song.component';
import { AdsSongService } from 'app/entities/ads-song/ads-song.service';
import { AdsSong } from 'app/shared/model/ads-song.model';

describe('Component Tests', () => {
  describe('AdsSong Management Component', () => {
    let comp: AdsSongComponent;
    let fixture: ComponentFixture<AdsSongComponent>;
    let service: AdsSongService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ServerTestModule],
        declarations: [AdsSongComponent],
        providers: [
          {
        ...
        .overrideTemplate(AdsSongComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AdsSongComponent);
