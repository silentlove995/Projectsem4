...
describe('Service Tests', () => {
  describe('Songs Service', () => {
    ...
    let elemDefault: ISongs;
    let expectedResult: ISongs | ISongs[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new Songs(0, 'AAAAAAA', Genre.Drama, 'AAAAAAA', Country.China, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 0);
    });
