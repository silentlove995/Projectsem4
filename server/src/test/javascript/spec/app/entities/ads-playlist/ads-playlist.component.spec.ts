...
import { AdsPlaylistComponent } from 'app/entities/ads-playlist/ads-playlist.component';
...
describe('Component Tests', () => {
  describe('AdsPlaylist Management Component', () => {
    let comp: AdsPlaylistComponent;
    let fixture: ComponentFixture<AdsPlaylistComponent>;
    let service: AdsPlaylistService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [ServerTestModule],
        declarations: [AdsPlaylistComponent],
        providers: [
          {
        ...
        .overrideTemplate(AdsPlaylistComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AdsPlaylistComponent);
