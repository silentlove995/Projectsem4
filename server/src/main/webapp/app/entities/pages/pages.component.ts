...
export class PagesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.pagesService
        ...
        .subscribe(
          (res: HttpResponse<IPages[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  trackId(index: number, item: IPages): number {
  ...
  delete(pages: IPages): void {
    const modalRef = this.modalService.open(PagesDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IPages[] | null, headers: HttpHeaders, page: number): void {
